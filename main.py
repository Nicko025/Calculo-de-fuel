...
##    sound=randint(1,4)
##    if sound==1:
##        PlaySound("ishtar_1.wav", SND_FILENAME)
##    if sound==2:
##        PlaySound("ishtar_2.wav", SND_FILENAME)
##    if sound==3:
##        PlaySound("ishtar_3.wav", SND_FILENAME)
##    if sound==4:
##        PlaySound("ishtar_4.wav", SND_FILENAME)
...
ventana.title("Calculo de Fuel v1.5")
...
##imagen = Image.open('racing_ishtar.jpg')
##imagen = imagen.resize((470,593))
